...
demerit_points INT NOT NULL DEFAULT 0.00,
...
borrower VARCHAR(64) NOT NULL REFERENCES users(school_email) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
owner VARCHAR(64) NOT NULL REFERENCES users(school_email) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
item VARCHAR(64) NOT NULL,
