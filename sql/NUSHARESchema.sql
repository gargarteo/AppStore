...
request_id INT NOT NULL SERIAL PRIMARY KEY,
...
CREATE TABLE loan (
transaction_id NUMERIC PRIMARY KEY REFERENCES requests(request_id) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
